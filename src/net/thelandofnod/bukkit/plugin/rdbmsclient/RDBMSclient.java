...
public class RDBMSclient extends JavaPlugin {
	private final RDBMSclientEventListener eventListener = new RDBMSclientEventListener(
			this);
	private final RDBMSclientPlayerListener playerListener = new RDBMSclientPlayerListener(
			this);
	public static Server server;
	public Player callingPlayer;
	PluginDescriptionFile pdfFile;

	public RDBMSclient(PluginLoader pluginLoader, Server instance,
