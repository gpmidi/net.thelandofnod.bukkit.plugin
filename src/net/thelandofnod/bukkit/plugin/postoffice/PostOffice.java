...
//				+ pdfFile.getVersion() + " is disabled!");
    ...
    public void assertReceivePackageEvent(String recipient, Integer packageId) {
        PostOfficeReceivePackageEvent porpe = new PostOfficeReceivePackageEvent(
                recipient, packageId);
        getServer().getPluginManager().callEvent(porpe);
    }

    public void assertMarkPackageReadEvent(String recipient, Integer packageId) {
        PostOfficeMarkPackageReadEvent pompre = new PostOfficeMarkPackageReadEvent(
                recipient, packageId);
